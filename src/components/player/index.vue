...
<script>
  ...
  const transationDuration = prefixStyle('transation-duration')
  ...
  export default {
    ...
    methods: {
      ...
      leave (el, done) {
        ...
        // this.$refs.cdWrapper.style.transation = 'all 0.4s'
        // const {x, y, scale} = this._getPosAndScale()
      ...
      afterLeave () {
        ...
        this.$refs.cdWrapper.style.animation = ''
        // this.$refs.cdWrapper.style.transation = ''
      ...
      middleTouchMove (e) {
        ...
        this.$refs.lyricList.$el.style[transationDuration] = '0'
        this.$refs.middleL.style.opacity = 1 - this.touch.percent
        this.$refs.middleL.style[transationDuration] = '0'
      },
      middleTouchEnd () {
        let offsetWidth
        let opacity
        ...
        const time = 300
        this.$refs.lyricList.$el.style[transform] = `translate3d(${offsetWidth}px,0,0)`
        this.$refs.lyricList.$el.style[transationDuration] = `${time}ms`
        this.$refs.middleL.style[transationDuration] = `${time}ms`
